		...
		$( "#walkthru-1" ).click(function() { 
			...
			$( "#walkthru-2" ).click(function() { 
				...
				$( "#feed-items" ).callout({
			        ...
			        width: 200,
			        align: "top",
			        msg: "Each product has a feed, letting prospective buyers ask questions.  Questions are relayed into the Salesforce org so the sales team can answer them in Chatter.  Customers leverage previous Q&A around a product by searching for answers. See the tab on the far left for more info about this app."
			    });
			    $.cookie("walkthru_done", "true");
			});
		});
	};
	
   $('#follow-button').click(function() {
	 alert('When a customer follows a product they might be asked for their email to receive alerts, or they if they wanted to receive notifications in Twitter or Chatter they could select those options.');
   });
